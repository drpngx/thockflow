...
fn main() -> Result<()> {
    ...
    for l in &layouts {
        ...
        for k in &l.keys {
            output.push_str(&format!("            PhysicalKey {{ width: {}, height: {}, x: {}, y: {}, rotation: {}, rx: {}, ry: {}, origin: KeyOrigin::{}, name: String::new() }},\n", k.width, k.height, k.x, k.y, k.rotation, k.rx, k.ry, k.origin));
        }
        output.push_str("        ],\n");
